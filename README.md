...
RSS Reader Advanced is a clean, modern Android RSS/Atom feed reader built as a ready-to-use Android Studio project. It lets you subscribe to any number of feeds, organize them as sources, browse all articles in one place, and keep your favorite items for later. It ships with handy extras like OPML import/export, article search, mark-all-as-read, background refresh with notifications, predefined feeds to get started quickly, dark mode, and localization into many languages. The project builds from a single codebase into two product flavours — a free (Lite) build and an unlimited Pro build. All you need is Android Studio installed on your system, and you can quickly make the necessary changes.
...
![Screenshot](./_screenshots/demo3.png)
...
1. Adjust the app configuration and build switches (such as the free/pro limits) in the following file:
   "app\src\main\java\de\bugfish\rssreaderadvanced\AppConfig.java"

2. If necessary, replace the default app image by replacing the image files located in:
   "app\src\main\res/"

3. If you intend to publish your own build, remember to update the application ID and namespace in the Gradle files. Using the same App-ID as another app may result in conflicts when installing them on devices simultaneously!
...
| **Description**                                                       | **Link**                                                                                         |
|----------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| Access the online documentation for this project. | [https://bugfishtm.github.io/android-advanced-rss-reader/index.html](https://bugfishtm.github.io/android-advanced-rss-reader/index.html)  |
...
- **GitHub Issues** is the main platform for reporting bugs, asking questions, or submitting feature requests: [https://github.com/bugfishtm/android-advanced-rss-reader/issues](https://github.com/bugfishtm/android-advanced-rss-reader/issues)
